    ...
    render(){
        return(
            <React.Fragment>
                ...
                {/* Start Pagehelmet  */}
                <PageHelmet pageTitle='Software Intern Position' />
                {/* End Pagehelmet  */}
                            ...
                            <div className="row row--35 align-items-center">
                                <div className="col-lg-5 order-1 order-lg-1">
                                    <div className="thumbnail">
                                        <img className="w-110" src="/assets/images/careers/software1.jpg" alt="software-intern-engineering-job"/>
                                    </div>
                                </div>
                                <div className="col-lg-7 order-2 order-lg-2" >
                                    <div className="about-inner inner">
                                        <div className="section-title">
                                            <h2 className="title">Software Engineering Intern</h2>
                                            <p className="description">We are looking for a young motivated individual who is ready to jump in to the world of Engineering. We are looking for candidates who are current exploring a B.S. degree in Engineering or Computer Science and have experience in some of the following fields.
                                            <ul>
                                                <li>
